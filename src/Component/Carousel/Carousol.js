...
import sofacollectionbanner from '../../assets/images/collection/sofacollectionbanner.jpg'

const Carousol = () => {
  return<>
  <section id="sofa-collection">
			<div className="owl-carousel owl-theme" id="collection-carousel">
				<div className="sofa-collection collectionbg1" style={{ backgroundImage: `url(${sofacollectionbanner})` }}>
				...
				<div className="sofa-collection collectionbg2"  style={{ backgroundImage: `url(${sofacollectionbanner})`}}>
					<div className="container">
						<div className="sofa-collection-txt">
